    ...
    <main>
        <div class="container">
            ...
            <form action="">
                ...
                <div class="input-box">
                    <input v-model="newpasswordInput" id="newpassword" type="password" placeholder="Enter your new password.." required>
                    <div class="underline"></div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async updateuserpw(e) {
            e.preventDefault()
            try {
                const response = await UserAPI.updateuserpw(this.newpasswordInput, this.passwordInput)
